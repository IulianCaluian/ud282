...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        if (grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2]) {
            if (grid[0][0] == 'x') return "X wins";
            else if (grid[0][0] == 'o') return "O wins";
        }
        if (grid[2][0] == grid[1][1] && grid[1][1] == grid[0][2]) {
            if (grid[1][1] == 'x') return "X wins";
            else if (grid[1][1] == 'o') return "O wins";
        }
